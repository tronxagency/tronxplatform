...
import { a as hasGateSessionMarker } from "./server-ClN5A9mv.mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
import { u as Skeleton } from "./router-BtGOnZ5x.mjs";
import { i as signOut, t as authClient } from "./client-B40BzJxt.mjs";
import { h as getWorkspace } from "./fns-n-8GfgDX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/workspace-D17jfZgR.js
	...
	if (q.isPending) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Skeleton, { className: "mt-6 h-8 w-48" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	if (q.isError || !q.data) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Couldn’t load workspace"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-1 max-w-sm text-sm text-muted-foreground",
				children: "If you just created an account, you need an enrollment invitation from a CEO, director or manager. Sign in with the enrolled email."
			}),
...
function useWorkspace() {
	const ctx = (0, import_react.useContext)(WorkspaceContext);
	if (!ctx) throw new Error("useWorkspace requires WorkspaceProvider");
	return ctx;
}
//#endregion
export { useWorkspace as a, useCurrentUserState as i, UserButton as n, WorkspaceProvider as r, RedirectToSignIn as t };
