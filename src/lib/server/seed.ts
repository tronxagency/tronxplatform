...
export async function seedOrganization(
  ...
  const existing = await sql`select id from projects where org_id = ${orgId} limit 1`;
  ...
  const people: Person[] = [
    ...
    { id: "seed_jordan", name: "Jordan Hale", title: "Design Lead", role: "team_lead", avatar: "sand", email: "jordan@tronx.dev", code: "TX-1006", phone: "+91 98000 10006", location: "Remote", skills: "product-design,systems,brand", bio: "Holds the visual system and design quality bar." },
    { id: "seed_hemanth", name: "Hemanth", title: "Backend Engineer", role: "employee", avatar: "stone", email: "hemanth@tronx.dev", code: "TX-1007", phone: "+91 98000 10007", location: "Bengaluru", skills: "postgres,node,integrations", bio: "Appointment APIs, identity and clinic integrations." },
    { id: "seed_infran", name: "Infran", title: "Full-stack Engineer", role: "employee", avatar: "zinc", email: "infran@tronx.dev", code: "TX-1008", phone: "+91 98000 10008", location: "Chennai", skills: "react,node,kds", bio: "Kitchen display, HL7 adapter and viewing scheduler." },
    { id: "seed_harsha", name: "Harsha", title: "Product Designer", role: "employee", avatar: "sand", email: "harsha@tronx.dev", code: "TX-1009", phone: "+91 98000 10009", location: "Bengaluru", skills: "ui,a11y,motion", bio: "Patient portal, menu builder and kiosk attract loop." },
    { id: "seed_faiziya", name: "Faiziya", title: "AI Engineer", role: "employee", avatar: "dusk", email: "faiziya@tronx.dev", code: "TX-1010", phone: "+91 98000 10010", location: "Bengaluru", skills: "llm,eval,voice", bio: "Reply copilot, kiosk voice and occupancy vision." },
  ...
  for (const pid of [ceoId, faiziya, prakash, harsha, ravi, maya]) {
    await sql`insert into project_members (project_id, profile_id) values (${kiosk}, ${pid}) on conflict do nothing`;
  }
  for (const pid of [ceoId, prakash, infran, aisha, harsha, maya]) {
  ...
  type TSeed = {
    id: string; project: string; title: string; desc: string; assignee: string;
    status: string; priority: string; due: number; est: number; act: number;
    tags: string; blocked?: string;
  };

  const tasks: TSeed[] = [
    { id: "t_h_portal", project: hospital, title: "Hospital patient portal", desc: "Patient-facing portal for appointments, records and prescriptions.", assignee: ceoId, status: "in_review", priority: "urgent", due: 0, est: 960, act: 840, tags: "frontend,portal" },
    { id: "t_h_api", project: hospital, title: "Patient appointment API", desc: "REST endpoints for booking, reschedule, cancel and slot search. Validation required before 6 PM.", assignee: hemanth, status: "in_progress", priority: "urgent", due: 0, est: 480, act: 300, tags: "backend,api" },
    { id: "t_h_valid", project: hospital, title: "Appointment request validation", desc: "Server-side validation for slots, insurance and overlapping bookings.", assignee: hemanth, status: "todo", priority: "high", due: 1, est: 240, act: 0, tags: "backend" },
    { id: "t_h_ehr", project: hospital, title: "EHR HL7 adapter", desc: "Inbound/outbound HL7 mapping for patient demographics.", assignee: infran, status: "blocked", priority: "high", due: 5, est: 720, act: 240, tags: "integration", blocked: "Waiting on clinic VPN credentials" },
    { id: "t_h_ui", project: hospital, title: "Ward operations board", desc: "Realtime board for bed occupancy and nurse assignments.", assignee: ravi, status: "todo", priority: "medium", due: 8, est: 360, act: 0, tags: "frontend" },
    { id: "t_h_auth", project: hospital, title: "Patient identity verification", desc: "OTP + ID document check for first-time portal access.", assignee: prakash, status: "completed", priority: "high", due: -6, est: 400, act: 420, tags: "security" },
    { id: "t_h_rx", project: hospital, title: "Prescription refill flow", desc: "Refill requests routed to the assigned physician.", assignee: ceoId, status: "changes_requested", priority: "high", due: 2, est: 320, act: 180, tags: "frontend" },
    { id: "t_h_qa", project: hospital, title: "Portal accessibility pass", desc: "WCAG AA pass on patient-facing screens.", assignee: harsha, status: "in_review", priority: "medium", due: 1, est: 180, act: 160, tags: "design,a11y" },
    { id: "t_h_lab", project: hospital, title: "Lab results timeline", desc: "Chronological lab results with downloadable PDFs.", assignee: ravi, status: "backlog", priority: "low", due: 14, est: 280, act: 0, tags: "frontend" },
    { id: "t_r_orders", project: restaurant, title: "Restaurant order API", desc: "Create, pay and route dine-in and takeaway orders.", assignee: prakash, status: "in_progress", priority: "urgent", due: 0, est: 600, act: 400, tags: "backend,api" },
    { id: "t_r_kds", project: restaurant, title: "Kitchen display system", desc: "Ticket routing, bump, recall and station filters.", assignee: infran, status: "in_progress", priority: "high", due: 4, est: 520, act: 200, tags: "frontend,kds" },
    { id: "t_r_auth", project: restaurant, title: "Staff PIN authentication", desc: "Device-local PIN with role-aware POS permissions.", assignee: hemanth, status: "completed", priority: "high", due: -8, est: 240, act: 250, tags: "security" },
    { id: "t_r_menu", project: restaurant, title: "Menu builder", desc: "Modifiers, availability windows and photo pipeline.", assignee: harsha, status: "in_review", priority: "medium", due: 2, est: 300, act: 220, tags: "design,frontend" },
    { id: "t_r_inv", project: restaurant, title: "Inventory depletion", desc: "Auto-decrement stock from KDS completion events.", assignee: ravi, status: "todo", priority: "medium", due: 7, est: 360, act: 0, tags: "backend" },
    { id: "t_r_an", project: restaurant, title: "Restaurant analytics v1", desc: "Hourly covers, item mix, voids and average ticket.", assignee: ceoId, status: "todo", priority: "low", due: 12, est: 400, act: 0, tags: "analytics" },
    { id: "t_r_pay", project: restaurant, title: "Split tender payments", desc: "Card + cash + voucher on a single check.", assignee: infran, status: "backlog", priority: "medium", due: 16, est: 280, act: 0, tags: "payments" },
    { id: "t_g_collect", project: reviews, title: "Review request journeys", desc: "SMS/email journeys timed after fulfilled orders.", assignee: aisha, status: "completed", priority: "high", due: -3, est: 240, act: 230, tags: "growth" },
    { id: "t_g_draft", project: reviews, title: "Reply copilot", desc: "Draft public replies in brand voice with sentiment guardrails.", assignee: faiziya, status: "in_progress", priority: "high", due: 1, est: 480, act: 300, tags: "ai" },
    { id: "t_g_dash", project: reviews, title: "Reputation dashboard", desc: "Location-level rating trend and topic clusters.", assignee: ravi, status: "in_review", priority: "medium", due: 3, est: 320, act: 280, tags: "frontend,analytics" },
    { id: "t_g_mod", project: reviews, title: "Moderation queue", desc: "Flag reviews that need a human before auto-reply.", assignee: ceoId, status: "todo", priority: "high", due: 0, est: 200, act: 0, tags: "ops" },
    { id: "t_g_lang", project: reviews, title: "Multilingual replies", desc: "Detect review language and draft in-kind.", assignee: faiziya, status: "backlog", priority: "low", due: 20, est: 360, act: 0, tags: "ai" },
    { id: "t_k_voice", project: kiosk, title: "Kiosk wake-word + barge-in", desc: "Local wake-word with interruption handling.", assignee: faiziya, status: "in_progress", priority: "high", due: 6, est: 600, act: 180, tags: "ai,voice" },
    { id: "t_k_ui", project: kiosk, title: "Kiosk attract loop", desc: "Idle motion, language picker, high-contrast mode.", assignee: harsha, status: "todo", priority: "medium", due: 8, est: 280, act: 0, tags: "design" },
    { id: "t_k_q", project: kiosk, title: "Queue ticket printer", desc: "Print + SMS ticket with estimated wait.", assignee: hemanth, status: "todo", priority: "medium", due: 11, est: 240, act: 0, tags: "hardware" },
    { id: "t_k_vis", project: kiosk, title: "Vision occupancy estimate", desc: "Anonymous headcount to feed wait-time model.", assignee: faiziya, status: "blocked", priority: "low", due: 30, est: 480, act: 0, tags: "ai,vision", blocked: "Legal review of camera policy" },
    { id: "t_e_list", project: estate, title: "Listings data model", desc: "Property, unit, media and amenity schema.", assignee: prakash, status: "in_progress", priority: "high", due: 4, est: 320, act: 80, tags: "backend" },
    { id: "t_e_crm", project: estate, title: "Agent CRM pipeline", desc: "Lead stages, viewing notes and follow-ups.", assignee: aisha, status: "todo", priority: "medium", due: 10, est: 400, act: 0, tags: "product" },
    { id: "t_e_cal", project: estate, title: "Viewing scheduler", desc: "Public booking page with agent buffers.", assignee: infran, status: "backlog", priority: "medium", due: 18, est: 360, act: 0, tags: "frontend" },
    { id: "t_e_docs", project: estate, title: "Document vault", desc: "Offer letters, KYC packs, e-sign status.", assignee: ceoId, status: "backlog", priority: "low", due: 24, est: 440, act: 0, tags: "docs" },
  ];
  ...
  const checks: [string, string, boolean][] = [
    ["t_h_api", "OpenAPI spec merged", true],
    ["t_h_api", "Slot search with timezone", true],
    ["t_h_api", "Overlap validation", false],
    ["t_h_api", "Insurance eligibility hook", false],
    ["t_h_portal", "Appointments list", true],
    ["t_h_portal", "Records viewer", true],
    ["t_h_portal", "Empty states", false],
    ["t_r_kds", "Ticket grouping", true],
    ["t_r_kds", "Bump + recall", false],
    ["t_g_draft", "Tone presets", true],
    ["t_g_draft", "Hallucination filter", false],
  ];
  let ci = 0;
  ...
  for (const ch of [chGeneral, chDev, chAi, chDesign, chHosp, chRest, chEngDep]) {
    for (const pid of allPeople) {
      await sql`insert into channel_members (channel_id, profile_id, last_read_at)
        values (${ch}, ${pid}, ${ago(6)}) on conflict do nothing`;
    }
  }

  const msgs: [string, string, string, number][] = [
    [chGeneral, ceoId, "Standup at 10. Bring blockers only — keep it tight.", 20],
    [chGeneral, aisha, "Review automation is on track for Thursday demo.", 18],
    [chDev, prakash, "Please don't merge into hospital/main without the migration check.", 14],
    [chDev, hemanth, "Appointment API branch is up: feat/hospital-appointments.", 12],
    [chDev, ravi, "Need the occupancy payload shape for the ward board.", 9],
    [chHosp, maya, "@Hemanth please finish patient appointment API by 6 PM.", 8],
    [chHosp, hemanth, "Working on it.", 7],
    [chHosp, prakash, "Great. Please also add validation.", 6],
    [chRest, prakash, "KDS staging is live with yesterday's order dump.", 11],
    [chRest, infran, "Bump animation still feels late on 4K displays. Looking.", 10],
    [chAi, faiziya, "Reply copilot eval set is in /files. Flag anything off-brand.", 5],
    [chDesign, harsha, "Uploaded the kiosk attract-loop frames.", 4],
    [chEngDep, maya, "Sprint review Friday. Bring a demo, not a slide.", 3],
  ];
  let mi = 0;
  ...
  await sql`insert into attachments (id, org_id, name, mime, size_bytes, project_id, task_id, uploaded_by, created_at) values
    ...
    (${"f2"}, ${orgId}, ${"patient-portal-flows.pdf"}, ${"application/pdf"}, ${1284000}, ${hospital}, ${"t_h_portal"}, ${harsha}, ${ago(20)}),
    (${"f3"}, ${orgId}, ${"kds-stations.fig"}, ${"application/octet-stream"}, ${8400000}, ${restaurant}, ${"t_r_kds"}, ${harsha}, ${ago(16)}),
    (${"f4"}, ${orgId}, ${"reply-eval-set.csv"}, ${"text/csv"}, ${88000}, ${reviews}, ${"t_g_draft"}, ${faiziya}, ${ago(6)}),
    (${"f5"}, ${orgId}, ${"kiosk-attract-loop.mp4"}, ${"video/mp4"}, ${18400000}, ${kiosk}, ${"t_k_ui"}, ${harsha}, ${ago(4)})`;
  ...
  const acts: [string, string, string, string, string, number][] = [
    [maya, "task", "t_g_mod", "assigned", "Assigned Moderation queue", 1.2],
    [hemanth, "task", "t_h_api", "status", "Moved Patient appointment API to In Progress", 3],
    [ravi, "task", "t_h_portal", "status", "Moved Hospital patient portal to In Review", 10],
    [infran, "task", "t_h_ehr", "blocked", "Marked EHR HL7 adapter as blocked", 9],
    [prakash, "project", restaurant, "update", "Updated Restaurant SaaS milestone dates", 16],
    [faiziya, "file", "f4", "upload", "Uploaded reply-eval-set.csv", 6],
    [harsha, "task", "t_h_qa", "status", "Submitted Portal accessibility pass for review", 8],
    [kiran, "employee", maya, "enrolled", "Enrolled Maya Shah as Engineering Manager", 30],
  ];
  for (const [actor, type, id, action, summary, hours] of acts) {
    await sql`insert into activity_logs (id, org_id, actor_id, entity_type, entity_id, action, summary, created_at)
